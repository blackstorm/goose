(() => {
  // app/javascript/alpinejs.js
  (() => {
    var We = false, Ge = false, B = [];
    function $t(e) {
      an(e);
    }
    function an(e) {
    ...
    function cn() {
      !Ge && !We && (We = true, queueMicrotask(ln));
    }
    function ln() {
      We = false, Ge = true;
    ...
    var A, K, Y, Ye, Je = true;
    function Lt(e) {
      Je = false, e(), Je = true;
    }
    function jt(e) {
      A = e.reactive, Y = e.release, K = (t) => e.effect(t, { scheduler: (r) => {
        Je ? $t(r) : r();
      } }), Ye = e.raw;
    }
    function Ze(e) {
    ...
    var et = new MutationObserver(Xe), tt = false;
    function rt() {
      et.observe(document, { subtree: true, childList: true, attributes: true, attributeOldValue: true }), tt = true;
    }
    function fn() {
      un(), et.disconnect(), tt = false;
    }
    var te = [], nt = false;
    function un() {
      te = te.concat(et.takeRecords()), te.length && !nt && (nt = true, queueMicrotask(() => {
        dn(), nt = false;
      }));
    }
    function dn() {
    ...
    function Xe(e) {
      ...
      for (let o of t)
        r.includes(o) || !o.isConnected || (delete o._x_ignoreSelf, delete o._x_ignore, zt.forEach((s) => s(o)), o._x_ignore = true, o._x_ignoreSelf = true);
      t.forEach((o) => {
      ...
      let t = new Proxy({}, { ownKeys: () => Array.from(new Set(e.flatMap((r) => Object.keys(r)))), has: (r, n) => e.some((i) => i.hasOwnProperty(n)), get: (r, n) => (e.find((i) => {
        if (i.hasOwnProperty(n)) {
          ...
          if ((o.get || o.set) && o.enumerable) {
            ...
            s = s && s.bind(t), a = a && a.bind(t), s && (s._x_alreadyBound = true), a && (a._x_alreadyBound = true), Object.defineProperty(i, n, { ...c, get: s, set: a });
          }
          return true;
        }
        return false;
...
` : ""}`, t), setTimeout(() => {
    ...
    var dt = false, ie = /* @__PURE__ */ new Map(), nr = Symbol();
    function ir(e) {
      dt = true;
      let t = Symbol();
      nr = t, ie.set(t, []);
    ...
    function at(e) {
      ...
      return t.push(i), [{ Alpine: I, effect: n, cleanup: r, evaluateLater: g.bind(g, e), evaluate: P.bind(P, e) }, () => t.forEach((a) => a())];
    }
    function gn(e, t) {
      let r = () => {
    ...
    var Ee = (e, t) => ({ name: r, value: n }) => (r.startsWith(e) && (r = r.replace(e, t)), { name: r, value: n }), Se = (e) => e;
    function tr(e = () => {
    }) {
    ...
    function xn(e, t) {
      return ({ name: r, value: n }) => {
        let i = r.match(sr()), o = r.match(/:([a-zA-Z0-9\-:]+)/), s = r.match(/\.[^.\]]+(?=[^\]]*$)/g) || [], a = t || e[r] || r;
        return { type: i ? i[1] : null, value: o ? o[1] : null, modifiers: s.map((c) => c.replace(".", "")), expression: n, original: a };
      };
    }
    var pt = "DEFAULT", Ae = ["ignore", "ref", "data", "id", "radio", "tabs", "switch", "disclosure", "menu", "listbox", "list", "item", "combobox", "bind", "init", "for", "mask", "model", "modelable", "transition", "show", "if", pt, "teleport"];
    function yn(e, t) {
    ...
    function R(e, t) {
      ...
      for (; n; )
        R(n, t, false), n = n.nextElementSibling;
    }
    function O(e, ...t) {
    ...
    function lr() {
      ...
      let e = (t) => !V(t.parentElement, true);
    ...
    function On(e, t, r) {
      ...
      let s = !t.includes("opacity") && !t.includes("scale"), a = s || t.includes("opacity"), c = s || t.includes("scale"), l = a ? 0 : 1, u = c ? ae(t, "scale", 95) / 100 : 1, p = ae(t, "delay", 0), y = ae(t, "origin", "center"), N = "opacity, transform", W = ae(t, "duration", 150) / 1e3, pe = ae(t, "duration", 75) / 1e3, f = "cubic-bezier(0.4, 0.0, 0.2, 1)";
      i && (e._x_transition.enter.during = { transformOrigin: y, transitionDelay: p, transitionProperty: N, transitionDuration: `${W}s`, transitionTimingFunction: f }, e._x_transition.enter.start = { opacity: l, transform: `scale(${u})` }, e._x_transition.enter.end = { opacity: 1, transform: "scale(1)" }), o && (e._x_transition.leave.during = { transformOrigin: y, transitionDelay: p, transitionProperty: N, transitionDuration: `${pe}s`, transitionTimingFunction: f }, e._x_transition.leave.start = { opacity: 1, transform: "scale(1)" }, e._x_transition.leave.end = { opacity: l, transform: `scale(${u})` });
    }
    function mr(e, t, r = {}) {
    ...
    window.Element.prototype._x_toggleAndCascadeWithTransitions = function(e, t, r, n) {
      ...
      e._x_hidePromise = e._x_transition ? new Promise((s, a) => {
        e._x_transition.out(() => {
        }, () => s(n)), e._x_transitioning.beforeCancel(() => a({ isFromCancelledTransition: true }));
    ...
    function hr(e) {
      let t = e.parentNode;
      if (!!t)
        return t._x_hidePromise ? t : hr(t);
    }
    ...
    function Tn(e, t) {
      let r, n, i, o = se(() => {
        m(() => {
          r = true, n || t.before(), i || (t.end(), Oe()), t.after(), e.isConnected && t.cleanup(), delete e._x_transitioning;
        });
      });
      e._x_transitioning = { beforeCancels: [], beforeCancel(s) {
        ...
        s === 0 && (s = Number(getComputedStyle(e).animationDuration.replace("s", "")) * 1e3), m(() => {
          ...
          r || (m(() => {
            t.end();
          }), Oe(), setTimeout(e._x_transitioning.finish, s + a), i = true);
        });
      });
    }
    function ae(e, t, r) {
    ...
    function _r(e, t) {
      t._x_dataStack || (t._x_dataStack = e._x_dataStack), gt = true, Rn(() => {
        Cn(t);
      }), gt = false;
    }
    function Cn(e) {
    ...
    function Mn(e, t) {
      if (e.type === "radio")
        e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = gr(e.value, t));
      else if (e.type === "checkbox")
        Number.isInteger(t) ? e.value = t : !Number.isInteger(t) && !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some((r) => gr(r, e.value)) : e.checked = !!t;
    ...
    function kn(e, t, r) {
      [null, void 0, false].includes(r) && Ln(t) ? e.removeAttribute(t) : (xr(t) && (r = t), $n(e, t, r));
    }
    function $n(e, t, r) {
    ...
    function xt(e, t, r) {
      ...
      i = i.map((s) => o.find((a) => a.name === s.name) ? { name: `x-bind:${s.name}`, value: `"${s.value}"` } : s), ne(e, i, r).map((s) => {
    ...
    var ns = { [1]: "TEXT", [2]: "CLASS", [4]: "STYLE", [8]: "PROPS", [16]: "FULL_PROPS", [32]: "HYDRATE_EVENTS", [64]: "STABLE_FRAGMENT", [128]: "KEYED_FRAGMENT", [256]: "UNKEYED_FRAGMENT", [512]: "NEED_PATCH", [1024]: "DYNAMIC_SLOTS", [2048]: "DEV_ROOT_FRAGMENT", [-1]: "HOISTED", [-2]: "BAIL" }, is = { [1]: "STABLE", [2]: "DYNAMIC", [3]: "FORWARDED" };
    ...
    var Bn = Object.prototype.hasOwnProperty, le = (e, t) => Bn.call(e, t), L = Array.isArray, X = (e) => Nr(e) === "[object Map]";
    ...
    }, Vn = /-(\w)/g, as = Ie((e) => e.replace(Vn, (t, r) => r ? r.toUpperCase() : "")), Hn = /\B([A-Z])/g, cs = Ie((e) => e.replace(Hn, "-$1").toLowerCase()), wt = Ie((e) => e.charAt(0).toUpperCase() + e.slice(1)), ls = Ie((e) => e ? `on${wt(e)}` : ""), Et = (e, t) => e !== t && (e === e || t === t);
    var St = /* @__PURE__ */ new WeakMap(), fe = [], M, U = Symbol("iterate"), At = Symbol("Map key iterate");
    function qn(e) {
    ...
    function Dr(e) {
      e.active && (kr(e), e.options.onStop && e.options.onStop(), e.active = false);
    }
    var Wn = 0;
    function Un(e, t) {
      let r = function() {
      ...
      return r.id = Wn++, r.allowRecurse = !!t.allowRecurse, r._isEffect = true, r.active = true, r.raw = e, r.deps = [], r.options = t, r;
    }
    function kr(e) {
      let { deps: t } = e;
      if (t.length) {
    ...
    function T(e, t, r) {
      ...
      let i = n.get(r);
      i || n.set(r, i = /* @__PURE__ */ new Set()), i.has(M) || (i.add(M), M.deps.push(i), M.options.onTrack && M.options.onTrack({ effect: M, target: e, type: t, key: r }));
    }
    ...
    var Jn = yt("__proto__,__v_isRef,__isVue"), $r = new Set(Object.getOwnPropertyNames(Symbol).map((e) => Symbol[e]).filter(ke)), Zn = $e(), Qn = $e(false, true), Xn = $e(true), ei = $e(true, true), Le = {};
    ...
    var Kr = { get: Zn, set: ni, deleteProperty: oi, has: si, ownKeys: ai }, zr = { get: Xn, set(e, t) {
    ...
    } }, hs = bt({}, Kr, { get: Qn, set: ii }), _s = bt({}, zr, { get: ei }), Ct = (e) => ue(e) ? je(e) : e, Rt = (e) => ue(e) ? Fr(e) : e, Mt = (e) => e, Fe = (e) => Reflect.getPrototypeOf(e);
    function Be(e, t, r = false, n = false) {
      e = e.__v_raw;
      let i = _(e), o = _(t);
    ...
    function He(e, t, r) {
      return function(...n) {
        let i = this.__v_raw, o = _(i), s = X(o), a = e === "entries" || e === Symbol.iterator && s, c = e === "keys" && s, l = i[e](...n), u = r ? Mt : t ? Rt : Ct;
        return !t && T(o, "iterate", c ? At : U), { next() {
    ...
    var Gr = { get(e) {
      ...
      return ze(this);
    }, has: Ke, add: Vr, set: qr, delete: Ur, clear: Wr, forEach: Ve(false, false) }, Yr = { get(e) {
      return Be(this, e, false, true);
    }, get size() {
      return ze(this);
    }, has: Ke, add: Vr, set: qr, delete: Ur, clear: Wr, forEach: Ve(false, true) }, Jr = { get(e) {
      return Be(this, e, true);
    }, get size() {
      return ze(this, true);
    }, has(e) {
      return Ke.call(this, e, true);
    }, add: F("add"), set: F("set"), delete: F("delete"), clear: F("clear"), forEach: Ve(true, false) }, Zr = { get(e) {
      return Be(this, e, true, true);
    }, get size() {
      return ze(this, true);
    }, has(e) {
      return Ke.call(this, e, true);
    }, add: F("add"), set: F("set"), delete: F("delete"), clear: F("clear"), forEach: Ve(true, true) }, ci = ["keys", "values", "entries", Symbol.iterator];
    ci.forEach((e) => {
      Gr[e] = He(e, false, false), Jr[e] = He(e, true, false), Yr[e] = He(e, false, true), Zr[e] = He(e, true, true);
    });
    function qe(e, t) {
      let r = t ? e ? Zr : Yr : e ? Jr : Gr;
      return (n, i, o) => i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(le(r, i) && i in n ? r : n, i, o);
    }
    var li = { get: qe(false, false) }, gs = { get: qe(false, true) }, ui = { get: qe(true, false) }, xs = { get: qe(true, true) };
    function Hr(e, t, r) {
      let n = _(r);
      if (n !== r && t.call(e, n)) {
        let i = vt(e);
    ...
    var Lr = /* @__PURE__ */ new WeakMap(), ti = /* @__PURE__ */ new WeakMap(), jr = /* @__PURE__ */ new WeakMap(), ri = /* @__PURE__ */ new WeakMap();
    function fi(e) {
      switch (e) {
        case "Object":
        case "Array":
    ...
    function je(e) {
      return e && e.__v_isReadonly ? e : Qr(e, false, Kr, li, Lr);
    }
    function Fr(e) {
      return Qr(e, true, zr, ui, jr);
    }
    ...
    d("teleport", (e, { expression: t }, { cleanup: r }) => {
      ...
      e._x_teleport = i, i._x_teleportBack = e, e._x_forwardEvents && e._x_forwardEvents.forEach((o) => {
        ...
        n.appendChild(i), w(i), i._x_ignore = true;
      }), r(() => i.remove());
    });
    var rn = () => {
    };
    ...
    function de(e, t, r, n) {
      ...
      if (r.includes("dot") && (t = mi(t)), r.includes("camel") && (t = hi(t)), r.includes("passive") && (s.passive = true), r.includes("capture") && (s.capture = true), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("prevent") && (o = a(o, (c, l) => {
        ...
        let c = r[r.indexOf("debounce") + 1] || "invalid-wait", l = kt(c.split("ms")[0]) ? Number(c.split("ms")[0]) : 250;
        o = Ne(o, l);
      }
      if (r.includes("throttle")) {
        let c = r[r.indexOf("throttle") + 1] || "invalid-wait", l = kt(c.split("ms")[0]) ? Number(c.split("ms")[0]) : 250;
        o = Pe(o, l);
      }
    ...
    d("model", (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
      ...
      e._x_model = { get() {
        ...
        o((y) => {
          y === void 0 && r.match(/\./) && (y = ""), window.fromModel = true, m(() => ce(e, "value", y)), delete window.fromModel;
        });
      }, n(() => {
    ...
    Re(() => `[${E("init")}]`);
    d("init", $((e, { expression: t }, { evaluate: r }) => typeof t == "string" ? !!t.trim() && r(t, {}, false) : r(t, {}, false)));
    ...
    d("html", (e, { expression: t }, { effect: r, evaluateLater: n }) => {
      ...
      r(() => {
        i((o) => {
          m(() => {
            e.innerHTML = o, e._x_ignoreSelf = true, w(e), delete e._x_ignoreSelf;
          });
        });
      });
    });
    ...
    function Ei(e, t, r, n) {
      ...
      r((s) => {
        ...
        for (let f = 0; f < p.length; f++) {
          ...
          let S = l[b], G = u[b], me = document.importNode(o.content, true).firstElementChild;
          C(me, A(S), o), m(() => {
            v.after(me), w(me);
...
//# sourceMappingURL=assets/alpinejs.js.map
